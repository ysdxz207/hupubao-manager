<template>
    <div style="height: 100%">
        ...
        <el-tooltip class="item" effect="dark" content="添加阿福类别" placement="top-start">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            _this.bus.$on(_this.Constants.Afu.type.name, function (search) {
                _this.search = search
                _this.loadPage()
            })
        ...
        methods: {
            ...
            editHandler(row) {
                ...
                _this.$router.push({name: _this.Constants.Afu.type.edit.name, query: query})
            }
        },
        watch: {}
    }
